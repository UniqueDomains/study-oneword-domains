...
**Public extract:** 9,639 rows · **Live catalog:** 5,622,033 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/study?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_study_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/study?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_study_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./study.csv">CSV</a> / <a href="./study.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_study_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_study_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .STUDY search](https://unique.domains/domains/tld/study?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_study_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .STUDY search](https://unique.domains/domains/tld/study?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_study_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./study.csv) or [Download JSON](./study.json)
...
- `study.csv` — public CSV extract (9,639 rows)
- `study.json` — public JSON extract (9,639 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,639-row public sample | 5,622,033 live domains                           |
...
| data.study       | premium   | $1,300    | $1,300        | 70             | 60     | 4      | namecheap                                   |
...
> Unique Domains. *Available .STUDY One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
